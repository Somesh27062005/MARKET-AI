...
def insights_node(state: InsightsState) -> dict:
    ...
    prompt = (
        ...
        f"5. Identify exactly 4 growth_opportunities with scored details (score 0-100), effort (Low/Medium/High), revenue_impact (Low/Medium/High), and description (a detailed explanation of 12-18 words).\n"
        f"6. Suggest exactly 3 new revenue_opportunities (source: 6-10 words, potential: 4-8 words, timeline: 2-4 words, and description: a detailed explanation of 12-18 words).\n"
